...
static struct itemplate instrux_AAA[] = {
    {I_AAA, 0, {0,0,0}, "\1\x37", IF_8086|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_AAD[] = {
    {I_AAD, 0, {0,0,0}, "\2\xD5\x0A", IF_8086|IF_NOLONG},
    {I_AAD, 1, {IMMEDIATE,0,0}, "\1\xD5\24", IF_8086|IF_SB|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_AAM[] = {
    {I_AAM, 0, {0,0,0}, "\2\xD4\x0A", IF_8086|IF_NOLONG},
    {I_AAM, 1, {IMMEDIATE,0,0}, "\1\xD4\24", IF_8086|IF_SB|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_AAS[] = {
    {I_AAS, 0, {0,0,0}, "\1\x3F", IF_8086|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_ADC[] = {
    ...
    {I_ADC, 2, {MEMORY,REG64,0}, "\321\300\1\x11\101", IF_X64|IF_SM},
    {I_ADC, 2, {REG64,REG64,0}, "\321\1\x11\101", IF_X64},
    ...
    {I_ADC, 2, {REG64,MEMORY,0}, "\321\301\1\x13\110", IF_X64|IF_SM},
    {I_ADC, 2, {REG64,REG64,0}, "\321\1\x13\110", IF_X64},
    ...
    {I_ADC, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\202\15", IF_X64},
    ...
    {I_ADC, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\202\15", IF_X64|IF_SM},
    {I_ADC, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\x15\41", IF_X64|IF_SM},
    ...
    {I_ADC, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\202\141", IF_X64|IF_SM},
...
static struct itemplate instrux_ADD[] = {
    ...
    {I_ADD, 2, {MEMORY,REG64,0}, "\321\300\1\x01\101", IF_X64|IF_SM},
    {I_ADD, 2, {REG64,REG64,0}, "\321\1\x01\101", IF_X64},
    ...
    {I_ADD, 2, {REG64,MEMORY,0}, "\321\301\1\x03\110", IF_X64|IF_SM},
    {I_ADD, 2, {REG64,REG64,0}, "\321\1\x03\110", IF_X64},
    ...
    {I_ADD, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\200\15", IF_X64},
    ...
    {I_ADD, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\200\15", IF_X64|IF_SM},
    {I_ADD, 2, {REG_RAX,IMMEDIATE,0}, "\323\1\x05\41", IF_X64|IF_SM},
    ...
    {I_ADD, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\200\141", IF_X64|IF_SM},
...
static struct itemplate instrux_AND[] = {
    ...
    {I_AND, 2, {MEMORY,REG64,0}, "\321\300\1\x21\101", IF_X64|IF_SM},
    {I_AND, 2, {REG64,REG64,0}, "\321\1\x21\101", IF_X64},
    ...
    {I_AND, 2, {REG64,MEMORY,0}, "\321\301\1\x23\110", IF_X64|IF_SM},
    {I_AND, 2, {REG64,REG64,0}, "\321\1\x23\110", IF_X64},
    ...
    {I_AND, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\204\15", IF_X64},
    ...
    {I_AND, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\204\15", IF_X64|IF_SM},
    {I_AND, 2, {REG_RAX,IMMEDIATE,0}, "\324\1\x25\41", IF_X64|IF_SM},
    ...
    {I_AND, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\204\141", IF_X64|IF_SM},
...
static struct itemplate instrux_ARPL[] = {
    {I_ARPL, 2, {MEMORY,REG16,0}, "\300\1\x63\101", IF_286|IF_PROT|IF_SM|IF_NOLONG},
    {I_ARPL, 2, {REG16,REG16,0}, "\1\x63\101", IF_286|IF_PROT|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_BOUND[] = {
    {I_BOUND, 2, {REG16,MEMORY,0}, "\320\301\1\x62\110", IF_186|IF_NOLONG},
    {I_BOUND, 2, {REG32,MEMORY,0}, "\321\301\1\x62\110", IF_386|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_BSF[] = {
    ...
    {I_BSF, 2, {REG64,MEMORY,0}, "\321\301\2\x0F\xBC\110", IF_X64|IF_SM},
    {I_BSF, 2, {REG64,REG64,0}, "\321\2\x0F\xBC\110", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_BSR[] = {
    ...
    {I_BSR, 2, {REG64,MEMORY,0}, "\321\301\2\x0F\xBD\110", IF_X64|IF_SM},
    {I_BSR, 2, {REG64,REG64,0}, "\321\2\x0F\xBD\110", IF_X64},
    ITEMPLATE_END
};

static struct itemplate instrux_BSWAP[] = {
    {I_BSWAP, 1, {REG32,0,0}, "\321\1\x0F\10\xC8", IF_486},
    {I_BSWAP, 1, {REG64,0,0}, "\321\1\x0F\10\xC8", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_BT[] = {
    ...
    {I_BT, 2, {MEMORY,REG64,0}, "\321\300\2\x0F\xA3\101", IF_X64|IF_SM},
    {I_BT, 2, {REG64,REG64,0}, "\321\2\x0F\xA3\101", IF_X64},
    ...
    {I_BT, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\2\x0F\xBA\204\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_BTC[] = {
    ...
    {I_BTC, 2, {MEMORY,REG64,0}, "\321\300\2\x0F\xBB\101", IF_X64|IF_SM},
    {I_BTC, 2, {REG64,REG64,0}, "\321\2\x0F\xBB\101", IF_X64},
    ...
    {I_BTC, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\2\x0F\xBA\207\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_BTR[] = {
    ...
    {I_BTR, 2, {MEMORY,REG64,0}, "\321\300\2\x0F\xB3\101", IF_X64|IF_SM},
    {I_BTR, 2, {REG64,REG64,0}, "\321\2\x0F\xB3\101", IF_X64},
    ...
    {I_BTR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\2\x0F\xBA\206\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_BTS[] = {
    ...
    {I_BTS, 2, {MEMORY,REG64,0}, "\321\300\2\x0F\xAB\101", IF_X64|IF_SM},
    {I_BTS, 2, {REG64,REG64,0}, "\321\2\x0F\xAB\101", IF_X64},
    ...
    {I_BTS, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\2\x0F\xBA\205\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_CALL[] = {
    ...
    {I_CALL, 1, {IMMEDIATE|FAR,0,0}, "\322\1\x9A\34\37", IF_8086|IF_NOLONG},
    {I_CALL, 1, {IMMEDIATE|BITS16,0,0}, "\320\1\xE8\64", IF_8086},
    {I_CALL, 1, {IMMEDIATE|BITS16|NEAR,0,0}, "\320\1\xE8\64", IF_8086},
    {I_CALL, 1, {IMMEDIATE|BITS16|FAR,0,0}, "\320\1\x9A\34\37", IF_8086|IF_NOLONG},
    {I_CALL, 1, {IMMEDIATE|BITS32,0,0}, "\321\1\xE8\64", IF_386},
    {I_CALL, 1, {IMMEDIATE|BITS32|NEAR,0,0}, "\321\1\xE8\64", IF_386},
    {I_CALL, 1, {IMMEDIATE|BITS32|FAR,0,0}, "\321\1\x9A\34\37", IF_386|IF_NOLONG},
    {I_CALL, 2, {IMMEDIATE|COLON,IMMEDIATE,0}, "\322\1\x9A\35\30", IF_8086|IF_NOLONG},
    {I_CALL, 2, {IMMEDIATE|BITS16|COLON,IMMEDIATE,0}, "\320\1\x9A\31\30", IF_8086|IF_NOLONG},
    {I_CALL, 2, {IMMEDIATE|COLON,IMMEDIATE|BITS16,0}, "\320\1\x9A\31\30", IF_8086|IF_NOLONG},
    {I_CALL, 2, {IMMEDIATE|BITS32|COLON,IMMEDIATE,0}, "\321\1\x9A\41\30", IF_386|IF_NOLONG},
    {I_CALL, 2, {IMMEDIATE|COLON,IMMEDIATE|BITS32,0}, "\321\1\x9A\41\30", IF_386|IF_NOLONG},
    ...
    {I_CALL, 1, {MEMORY|BITS32|NEAR,0,0}, "\321\300\1\xFF\202", IF_386|IF_NOLONG},
    {I_CALL, 1, {MEMORY|BITS64|NEAR,0,0}, "\321\300\1\xFF\202", IF_X64},
    {I_CALL, 1, {REG16,0,0}, "\320\300\1\xFF\202", IF_8086},
    {I_CALL, 1, {REG32,0,0}, "\321\300\1\xFF\202", IF_386|IF_NOLONG},
    {I_CALL, 1, {REG64,0,0}, "\321\300\1\xFF\202", IF_X64},
    {I_CALL, 1, {MEMORY,0,0}, "\322\300\1\xFF\202", IF_8086},
    {I_CALL, 1, {MEMORY|BITS16,0,0}, "\320\300\1\xFF\202", IF_8086},
    {I_CALL, 1, {MEMORY|BITS32,0,0}, "\321\300\1\xFF\202", IF_386|IF_NOLONG},
    {I_CALL, 1, {MEMORY|BITS64,0,0}, "\321\300\1\xFF\202", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_CDQE[] = {
    {I_CDQE, 0, {0,0,0}, "\324\1\x98", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_CLFLUSH[] = {
    {I_CLFLUSH, 1, {MEMORY|BITS8,0,0}, "\300\2\x0F\x80\207", IF_X64|IF_AMD|IF_SM},
    {I_CLFLUSH, 1, {MEMORY,0,0}, "\300\2\x0F\xAE\207", IF_WILLAMETTE|IF_SSE2},
    ITEMPLATE_END
};

static struct itemplate instrux_CLGI[] = {
    {I_CLGI, 0, {0,0,0}, "\3\x0F\x01\xDD", IF_X64|IF_AMD},
    ITEMPLATE_END
};
...
static struct itemplate instrux_CMP[] = {
    ...
    {I_CMP, 2, {MEMORY,REG64,0}, "\321\300\1\x39\101", IF_X64|IF_SM},
    {I_CMP, 2, {REG64,REG64,0}, "\321\1\x39\101", IF_X64},
    ...
    {I_CMP, 2, {REG64,MEMORY,0}, "\321\301\1\x3B\110", IF_X64|IF_SM},
    {I_CMP, 2, {REG64,REG64,0}, "\321\1\x3B\110", IF_X64},
    ...
    {I_CMP, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\207\15", IF_X64},
    ...
    {I_CMP, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\207\15", IF_X64|IF_SM},
    {I_CMP, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\x3D\41", IF_X64|IF_SM},
    ...
    {I_CMP, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\207\141", IF_X64|IF_SM},
...
static struct itemplate instrux_CMPSQ[] = {
    {I_CMPSQ, 0, {0,0,0}, "\332\324\1\xA7", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_CMPXCHG[] = {
    ...
    {I_CMPXCHG, 2, {MEMORY,REG64,0}, "\321\300\2\x0F\xB1\101", IF_X64|IF_SM},
    {I_CMPXCHG, 2, {REG64,REG64,0}, "\321\2\x0F\xB1\101", IF_X64},
    ITEMPLATE_END
};

static struct itemplate instrux_CMPXCHG16B[] = {
    {I_CMPXCHG16B, 1, {MEMORY,0,0}, "\324\300\2\x0F\xC7\201", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_CQO[] = {
    {I_CQO, 0, {0,0,0}, "\324\1\x99", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_DAA[] = {
    {I_DAA, 0, {0,0,0}, "\1\x27", IF_8086|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_DAS[] = {
    {I_DAS, 0, {0,0,0}, "\1\x2F", IF_8086|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_DEC[] = {
    {I_DEC, 1, {REG16,0,0}, "\320\10\x48", IF_8086|IF_NOLONG},
    {I_DEC, 1, {REG32,0,0}, "\321\10\x48", IF_386|IF_NOLONG},
    ...
    {I_DEC, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xFF\201", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_DIV[] = {
    ...
    {I_DIV, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xF7\206", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_IDIV[] = {
    ...
    {I_IDIV, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xF7\207", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_IMUL[] = {
    ...
    {I_IMUL, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xF7\205", IF_X64},
    ...
    {I_IMUL, 2, {REG64,MEMORY,0}, "\321\301\2\x0F\xAF\110", IF_X64|IF_SM},
    {I_IMUL, 2, {REG64,REG64,0}, "\321\2\x0F\xAF\110", IF_X64},
    ...
    {I_IMUL, 3, {REG64,MEMORY,IMMEDIATE|BITS8}, "\321\301\1\x6B\110\16", IF_X64|IF_SM},
    {I_IMUL, 3, {REG64,MEMORY,SBYTE}, "\321\301\1\x6B\110\16", IF_X64|IF_SM},
    {I_IMUL, 3, {REG64,MEMORY,IMMEDIATE|BITS32}, "\321\301\1\x69\110\42", IF_X64|IF_SM},
    {I_IMUL, 3, {REG64,MEMORY,IMMEDIATE}, "\321\301\145\1\x69\110\142", IF_X64|IF_SM},
    {I_IMUL, 3, {REG64,REG64,IMMEDIATE|BITS8}, "\321\1\x6B\110\16", IF_X64},
    {I_IMUL, 3, {REG64,REG64,SBYTE}, "\321\1\x6B\110\16", IF_X64|IF_SM},
    {I_IMUL, 3, {REG64,REG64,IMMEDIATE|BITS32}, "\321\1\x69\110\42", IF_X64},
    {I_IMUL, 3, {REG64,REG64,IMMEDIATE}, "\321\145\1\x69\110\142", IF_X64|IF_SM},
    ...
    {I_IMUL, 2, {REG64,SBYTE,0}, "\321\1\x6B\100\15", IF_X64|IF_SM},
    {I_IMUL, 2, {REG64,IMMEDIATE|BITS32,0}, "\321\1\x69\100\41", IF_X64},
    {I_IMUL, 2, {REG64,IMMEDIATE,0}, "\321\144\1\x69\100\141", IF_X64|IF_SM},
    ITEMPLATE_END
};
...
static struct itemplate instrux_INC[] = {
    {I_INC, 1, {REG16,0,0}, "\320\10\x40", IF_8086|IF_NOLONG},
    {I_INC, 1, {REG32,0,0}, "\321\10\x40", IF_386|IF_NOLONG},
    ...
    {I_INC, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xFF\200", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_INTO[] = {
    {I_INTO, 0, {0,0,0}, "\1\xCE", IF_8086|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_INVLPGA[] = {
    {I_INVLPGA, 0, {0,0,0}, "\3\x0F\x01\xDF", IF_X64|IF_AMD},
    ITEMPLATE_END
};
...
static struct itemplate instrux_IRETQ[] = {
    {I_IRETQ, 0, {0,0,0}, "\324\1\xCF", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_JCXZ[] = {
    {I_JCXZ, 1, {IMMEDIATE,0,0}, "\310\1\xE3\50", IF_8086|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_JMP[] = {
    ...
    {I_JMP, 1, {IMMEDIATE|FAR,0,0}, "\322\1\xEA\34\37", IF_8086|IF_NOLONG},
    {I_JMP, 1, {IMMEDIATE|BITS16,0,0}, "\320\1\xE9\64", IF_8086},
    {I_JMP, 1, {IMMEDIATE|BITS16|NEAR,0,0}, "\320\1\xE9\64", IF_8086},
    {I_JMP, 1, {IMMEDIATE|BITS16|FAR,0,0}, "\320\1\xEA\34\37", IF_8086|IF_NOLONG},
    {I_JMP, 1, {IMMEDIATE|BITS32,0,0}, "\321\1\xE9\64", IF_386},
    {I_JMP, 1, {IMMEDIATE|BITS32|NEAR,0,0}, "\321\1\xE9\64", IF_386},
    {I_JMP, 1, {IMMEDIATE|BITS32|FAR,0,0}, "\321\1\xEA\34\37", IF_386|IF_NOLONG},
    {I_JMP, 2, {IMMEDIATE|COLON,IMMEDIATE,0}, "\322\1\xEA\35\30", IF_8086|IF_NOLONG},
    {I_JMP, 2, {IMMEDIATE|BITS16|COLON,IMMEDIATE,0}, "\320\1\xEA\31\30", IF_8086|IF_NOLONG},
    {I_JMP, 2, {IMMEDIATE|COLON,IMMEDIATE|BITS16,0}, "\320\1\xEA\31\30", IF_8086|IF_NOLONG},
    {I_JMP, 2, {IMMEDIATE|BITS32|COLON,IMMEDIATE,0}, "\321\1\xEA\41\30", IF_386|IF_NOLONG},
    {I_JMP, 2, {IMMEDIATE|COLON,IMMEDIATE|BITS32,0}, "\321\1\xEA\41\30", IF_386|IF_NOLONG},
    ...
    {I_JMP, 1, {MEMORY|BITS32|NEAR,0,0}, "\321\300\1\xFF\204", IF_386|IF_NOLONG},
    {I_JMP, 1, {MEMORY|BITS64|NEAR,0,0}, "\321\300\1\xFF\204", IF_X64},
    {I_JMP, 1, {REG16,0,0}, "\320\300\1\xFF\204", IF_8086},
    {I_JMP, 1, {REG32,0,0}, "\321\300\1\xFF\204", IF_386|IF_NOLONG},
    {I_JMP, 1, {REG64,0,0}, "\321\300\1\xFF\204", IF_X64},
    {I_JMP, 1, {MEMORY,0,0}, "\322\300\1\xFF\204", IF_8086},
    {I_JMP, 1, {MEMORY|BITS16,0,0}, "\320\300\1\xFF\204", IF_8086},
    {I_JMP, 1, {MEMORY|BITS32,0,0}, "\321\300\1\xFF\204", IF_386|IF_NOLONG},
    {I_JMP, 1, {MEMORY|BITS64,0,0}, "\321\300\1\xFF\204", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_JRCXZ[] = {
    {I_JRCXZ, 1, {IMMEDIATE,0,0}, "\300\1\xE3\50", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_LAR[] = {
    ...
    {I_LAR, 2, {REG64,MEMORY,0}, "\321\301\2\x0F\x02\110", IF_X64|IF_SM},
    {I_LAR, 2, {REG64,REG64,0}, "\321\2\x0F\x02\110", IF_X64|IF_PROT},
    ITEMPLATE_END
};
...
static struct itemplate instrux_LDS[] = {
    {I_LDS, 2, {REG16,MEMORY,0}, "\320\301\1\xC5\110", IF_8086|IF_NOLONG},
    {I_LDS, 2, {REG32,MEMORY,0}, "\321\301\1\xC5\110", IF_386|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_LEA[] = {
    ...
    {I_LEA, 2, {REG64,MEMORY,0}, "\321\301\1\x8D\110", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_LES[] = {
    {I_LES, 2, {REG16,MEMORY,0}, "\320\301\1\xC4\110", IF_8086|IF_NOLONG},
    {I_LES, 2, {REG32,MEMORY,0}, "\321\301\1\xC4\110", IF_386|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_LFENCE[] = {
    {I_LFENCE, 0, {0,0,0}, "\3\x0F\xAE\xE8", IF_X64|IF_AMD},
...
static struct itemplate instrux_LODSQ[] = {
    {I_LODSQ, 0, {0,0,0}, "\324\1\xAD", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_LSL[] = {
    ...
    {I_LSL, 2, {REG64,MEMORY,0}, "\321\301\2\x0F\x03\110", IF_X64|IF_SM},
    {I_LSL, 2, {REG64,REG64,0}, "\321\2\x0F\x03\110", IF_X64|IF_PROT},
    ITEMPLATE_END
};
...
static struct itemplate instrux_LTR[] = {
    ...
    {I_LTR, 1, {MEMORY|BITS16,0,0}, "\300\1\x0F\17\203", IF_286|IF_PROT|IF_PRIV|IF_NOLONG},
    {I_LTR, 1, {REG16,0,0}, "\1\x0F\17\203", IF_286|IF_PROT|IF_PRIV|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_MFENCE[] = {
    {I_MFENCE, 0, {0,0,0}, "\3\x0F\xAE\xF0", IF_X64|IF_AMD},
...
static struct itemplate instrux_MOV[] = {
    ...
    {I_MOV, 2, {REG_RAX,MEM_OFFS,0}, "\301\324\1\xA1\45", IF_X64|IF_SM},
    ...
    {I_MOV, 2, {MEM_OFFS,REG_RAX,0}, "\300\324\1\xA3\44", IF_X64|IF_SM},
    {I_MOV, 2, {REG32,REG_CREG,0}, "\334\2\x0F\x20\101", IF_386|IF_PRIV|IF_NOLONG},
    {I_MOV, 2, {REG64,REG_CREG,0}, "\323\2\x0F\x20\101", IF_X64|IF_PRIV},
    {I_MOV, 2, {REG_CREG,REG32,0}, "\334\2\x0F\x22\110", IF_386|IF_PRIV|IF_NOLONG},
    {I_MOV, 2, {REG_CREG,REG64,0}, "\323\2\x0F\x22\110", IF_X64|IF_PRIV},
    {I_MOV, 2, {REG32,REG_DREG,0}, "\2\x0F\x21\101", IF_386|IF_PRIV},
    {I_MOV, 2, {REG64,REG_DREG,0}, "\323\2\x0F\x21\101", IF_X64|IF_PRIV},
    {I_MOV, 2, {REG_DREG,REG32,0}, "\2\x0F\x23\110", IF_386|IF_PRIV},
    {I_MOV, 2, {REG_DREG,REG64,0}, "\323\2\x0F\x23\110", IF_X64|IF_PRIV},
    {I_MOV, 2, {REG32,REG_TREG,0}, "\2\x0F\x24\101", IF_386|IF_NOLONG},
    {I_MOV, 2, {REG_TREG,REG32,0}, "\2\x0F\x26\110", IF_386|IF_NOLONG},
    ...
    {I_MOV, 2, {MEMORY,REG64,0}, "\324\300\1\x89\101", IF_X64|IF_SM},
    {I_MOV, 2, {REG64,REG64,0}, "\321\1\x89\101", IF_X64},
    ...
    {I_MOV, 2, {REG64,MEMORY,0}, "\324\301\1\x8B\110", IF_X64|IF_SM},
    {I_MOV, 2, {REG64,REG64,0}, "\321\1\x8B\110", IF_X64},
    ...
    {I_MOV, 2, {REG64,IMMEDIATE,0}, "\324\10\xB8\55", IF_X64|IF_SM},
    ...
    {I_MOV, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\324\300\1\xC7\200\41", IF_X64|IF_SM},
...
static struct itemplate instrux_MOVD[] = {
    ...
    {I_MOVD, 2, {MMXREG,REG64,0}, "\2\x0F\x6E\110", IF_X64|IF_MMX},
    {I_MOVD, 2, {MEMORY,MMXREG,0}, "\300\2\x0F\x7E\101", IF_PENT|IF_MMX|IF_SD},
    {I_MOVD, 2, {REG32,MMXREG,0}, "\2\x0F\x7E\101", IF_PENT|IF_MMX},
    {I_MOVD, 2, {REG64,MMXREG,0}, "\2\x0F\x7E\101", IF_X64|IF_MMX},
    {I_MOVD, 2, {XMMREG,MEMORY,0}, "\320\301\2\x0F\x6E\110", IF_X64|IF_SD},
    {I_MOVD, 2, {XMMREG,REG32,0}, "\320\2\x0F\x6E\110", IF_X64},
    {I_MOVD, 2, {XMMREG,REG64,0}, "\320\2\x0F\x6E\110", IF_X64},
    {I_MOVD, 2, {MEMORY,XMMREG,0}, "\320\300\2\x0F\x7E\101", IF_X64|IF_SD},
    {I_MOVD, 2, {REG32,XMMREG,0}, "\320\2\x0F\x7E\101", IF_X64|IF_SSE},
    {I_MOVD, 2, {REG64,XMMREG,0}, "\320\2\x0F\x7E\101", IF_X64|IF_SSE},
...
static struct itemplate instrux_MOVMSKPD[] = {
    {I_MOVMSKPD, 2, {REG32,XMMREG,0}, "\320\2\x0F\x50\101", IF_X64|IF_SSE},
    {I_MOVMSKPD, 2, {REG32,XMMREG,0}, "\3\x66\x0F\x50\110", IF_WILLAMETTE|IF_SSE2},
    ITEMPLATE_END
};

static struct itemplate instrux_MOVMSKPS[] = {
    {I_MOVMSKPS, 2, {REG32,XMMREG,0}, "\2\x0F\x50\101", IF_X64|IF_SSE},
...
static struct itemplate instrux_MOVSQ[] = {
    {I_MOVSQ, 0, {0,0,0}, "\324\1\xA5", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_MOVSX[] = {
    ...
    {I_MOVSX, 2, {REG64,REGMEM|BITS8,0}, "\321\301\2\x0F\xBE\110", IF_X64},
    {I_MOVSX, 2, {REG64,REGMEM|BITS16,0}, "\321\301\2\x0F\xBF\110", IF_X64},
    {I_MOVSX, 2, {REG64,REGMEM|BITS32,0}, "\321\301\1\x63\110", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_MOVZX[] = {
    ...
    {I_MOVZX, 2, {REG64,REGMEM|BITS8,0}, "\321\301\2\x0F\xB6\110", IF_X64},
    {I_MOVZX, 2, {REG64,REGMEM|BITS16,0}, "\321\301\2\x0F\xB7\110", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_MUL[] = {
    ...
    {I_MUL, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xF7\204", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_NEG[] = {
    ...
    {I_NEG, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xF7\203", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_NOT[] = {
    ...
    {I_NOT, 1, {REGMEM|BITS64,0,0}, "\321\300\1\xF7\202", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_OR[] = {
    ...
    {I_OR, 2, {MEMORY,REG64,0}, "\321\300\1\x09\101", IF_X64|IF_SM},
    {I_OR, 2, {REG64,REG64,0}, "\321\1\x09\101", IF_X64},
    ...
    {I_OR, 2, {REG64,MEMORY,0}, "\321\301\1\x0B\110", IF_X64|IF_SM},
    {I_OR, 2, {REG64,REG64,0}, "\321\1\x0B\110", IF_X64},
    ...
    {I_OR, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\201\15", IF_X64},
    ...
    {I_OR, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\201\15", IF_X64|IF_SM},
    {I_OR, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\x0D\41", IF_X64|IF_SM},
    ...
    {I_OR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\201\141", IF_X64|IF_SM},
...
static struct itemplate instrux_PAUSE[] = {
    {I_PAUSE, 0, {0,0,0}, "\2\xF3\x90", IF_X64|IF_AMD},
...
static struct itemplate instrux_POP[] = {
    ...
    {I_POP, 1, {REG32,0,0}, "\321\10\x58", IF_386|IF_NOLONG},
    {I_POP, 1, {REG64,0,0}, "\323\10\x58", IF_X64},
    {I_POP, 1, {REGMEM|BITS16,0,0}, "\320\300\1\x8F\200", IF_8086},
    {I_POP, 1, {REGMEM|BITS32,0,0}, "\321\300\1\x8F\200", IF_386|IF_NOLONG},
    {I_POP, 1, {REGMEM|BITS64,0,0}, "\323\300\1\x8F\200", IF_X64},
    {I_POP, 1, {REG_CS,0,0}, "\1\x0F", IF_8086|IF_UNDOC},
    {I_POP, 1, {REG_DESS,0,0}, "\4", IF_8086|IF_NOLONG},
    {I_POP, 1, {REG_FSGS,0,0}, "\1\x0F\5", IF_386},
    ITEMPLATE_END
};

static struct itemplate instrux_POPA[] = {
    {I_POPA, 0, {0,0,0}, "\322\1\x61", IF_186|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_POPAD[] = {
    {I_POPAD, 0, {0,0,0}, "\321\1\x61", IF_386|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_POPAW[] = {
    {I_POPAW, 0, {0,0,0}, "\320\1\x61", IF_186|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_POPFD[] = {
    {I_POPFD, 0, {0,0,0}, "\321\1\x9D", IF_386|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_POPFQ[] = {
    {I_POPFQ, 0, {0,0,0}, "\321\1\x9D", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_PUSH[] = {
    ...
    {I_PUSH, 1, {REG32,0,0}, "\321\10\x50", IF_386|IF_NOLONG},
    {I_PUSH, 1, {REG64,0,0}, "\323\10\x50", IF_X64},
    {I_PUSH, 1, {REGMEM|BITS16,0,0}, "\320\300\1\xFF\206", IF_8086},
    {I_PUSH, 1, {REGMEM|BITS32,0,0}, "\321\300\1\xFF\206", IF_386|IF_NOLONG},
    {I_PUSH, 1, {REGMEM|BITS64,0,0}, "\323\300\1\xFF\206", IF_X64},
    {I_PUSH, 1, {REG_CS,0,0}, "\6", IF_8086|IF_NOLONG},
    {I_PUSH, 1, {REG_DESS,0,0}, "\6", IF_8086|IF_NOLONG},
    ...
    {I_PUSH, 1, {IMMEDIATE|BITS32,0,0}, "\321\143\1\x68\140", IF_386|IF_NOLONG},
    {I_PUSH, 1, {IMMEDIATE|BITS64,0,0}, "\321\143\1\x68\140", IF_X64},
    {I_PUSH, 1, {IMMEDIATE,0,0}, "\1\x68\34", IF_186},
    ITEMPLATE_END
};

static struct itemplate instrux_PUSHA[] = {
    {I_PUSHA, 0, {0,0,0}, "\322\1\x60", IF_186|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_PUSHAD[] = {
    {I_PUSHAD, 0, {0,0,0}, "\321\1\x60", IF_386|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_PUSHAW[] = {
    {I_PUSHAW, 0, {0,0,0}, "\320\1\x60", IF_186|IF_NOLONG},
    ITEMPLATE_END
};
...
static struct itemplate instrux_PUSHFD[] = {
    {I_PUSHFD, 0, {0,0,0}, "\321\1\x9C", IF_386|IF_NOLONG},
    ITEMPLATE_END
};

static struct itemplate instrux_PUSHFQ[] = {
    {I_PUSHFQ, 0, {0,0,0}, "\321\1\x9C", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_RCL[] = {
    ...
    {I_RCL, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\202", IF_X64},
    {I_RCL, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\202", IF_X64},
    {I_RCL, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\202\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_RCR[] = {
    ...
    {I_RCR, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\203", IF_X64},
    {I_RCR, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\203", IF_X64},
    {I_RCR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\203\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_RDTSCP[] = {
    {I_RDTSCP, 0, {0,0,0}, "\3\x0F\x01\xF9", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_ROL[] = {
    ...
    {I_ROL, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\200", IF_X64},
    {I_ROL, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\200", IF_X64},
    {I_ROL, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\200\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_ROR[] = {
    ...
    {I_ROR, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\201", IF_X64},
    {I_ROR, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\201", IF_X64},
    {I_ROR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\201\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SAL[] = {
    ...
    {I_SAL, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\204", IF_X64},
    {I_SAL, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\204", IF_X64},
    {I_SAL, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\204\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SAR[] = {
    ...
    {I_SAR, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\207", IF_X64},
    {I_SAR, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\207", IF_X64},
    {I_SAR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\207\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SBB[] = {
    ...
    {I_SBB, 2, {MEMORY,REG64,0}, "\321\300\1\x19\101", IF_X64|IF_SM},
    {I_SBB, 2, {REG64,REG64,0}, "\321\1\x19\101", IF_X64},
    ...
    {I_SBB, 2, {REG64,MEMORY,0}, "\321\301\1\x1B\110", IF_X64|IF_SM},
    {I_SBB, 2, {REG64,REG64,0}, "\321\1\x1B\110", IF_X64},
    ...
    {I_SBB, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\203\15", IF_X64},
    ...
    {I_SBB, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\203\15", IF_X64|IF_SM},
    {I_SBB, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\x1D\41", IF_X64|IF_SM},
    ...
    {I_SBB, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\203\141", IF_X64|IF_SM},
...
static struct itemplate instrux_SCASQ[] = {
    {I_SCASQ, 0, {0,0,0}, "\332\324\1\xAF", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SFENCE[] = {
    {I_SFENCE, 0, {0,0,0}, "\3\x0F\xAE\xF8", IF_X64|IF_AMD},
...
static struct itemplate instrux_SHL[] = {
    ...
    {I_SHL, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\204", IF_X64},
    {I_SHL, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\204", IF_X64},
    {I_SHL, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\204\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SHLD[] = {
    ...
    {I_SHLD, 3, {MEMORY,REG64,IMMEDIATE}, "\300\321\2\x0F\xA4\101\26", IF_X64|IF_SM2|IF_SB|IF_AR2},
    {I_SHLD, 3, {REG64,REG64,IMMEDIATE}, "\321\2\x0F\xA4\101\26", IF_X64|IF_SM2|IF_SB|IF_AR2},
    ...
    {I_SHLD, 3, {MEMORY,REG64,REG_CL}, "\300\321\2\x0F\xA5\101", IF_X64|IF_SM},
    {I_SHLD, 3, {REG64,REG64,REG_CL}, "\321\2\x0F\xA5\101", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SHR[] = {
    ...
    {I_SHR, 2, {REGMEM|BITS64,UNITY,0}, "\321\300\1\xD1\205", IF_X64},
    {I_SHR, 2, {REGMEM|BITS64,REG_CL,0}, "\321\300\1\xD3\205", IF_X64},
    {I_SHR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xC1\205\25", IF_X64|IF_SB},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SHRD[] = {
    ...
    {I_SHRD, 3, {MEMORY,REG64,IMMEDIATE}, "\300\321\2\x0F\xAC\101\26", IF_X64|IF_SM2|IF_SB|IF_AR2},
    {I_SHRD, 3, {REG64,REG64,IMMEDIATE}, "\321\2\x0F\xAC\101\26", IF_X64|IF_SM2|IF_SB|IF_AR2},
    ...
    {I_SHRD, 3, {MEMORY,REG64,REG_CL}, "\300\321\2\x0F\xAD\101", IF_X64|IF_SM},
    {I_SHRD, 3, {REG64,REG64,REG_CL}, "\321\2\x0F\xAD\101", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SKINIT[] = {
    {I_SKINIT, 0, {0,0,0}, "\3\x0F\x01\xDE", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_STGI[] = {
    {I_STGI, 0, {0,0,0}, "\3\x0F\x01\xDC", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_STOSQ[] = {
    {I_STOSQ, 0, {0,0,0}, "\324\1\xAB", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_STR[] = {
    ...
    {I_STR, 1, {REG64,0,0}, "\321\1\x0F\17\201", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_SUB[] = {
    ...
    {I_SUB, 2, {MEMORY,REG64,0}, "\321\300\1\x29\101", IF_X64|IF_SM},
    {I_SUB, 2, {REG64,REG64,0}, "\321\1\x29\101", IF_X64},
    ...
    {I_SUB, 2, {REG64,MEMORY,0}, "\321\301\1\x2B\110", IF_X64|IF_SM},
    {I_SUB, 2, {REG64,REG64,0}, "\321\1\x2B\110", IF_X64},
    ...
    {I_SUB, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\205\15", IF_X64},
    ...
    {I_SUB, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\205\15", IF_X64|IF_SM},
    {I_SUB, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\x2D\41", IF_X64|IF_SM},
    ...
    {I_SUB, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\205\141", IF_X64|IF_SM},
...
static struct itemplate instrux_SWAPGS[] = {
    {I_SWAPGS, 0, {0,0,0}, "\3\x0F\x01\xF8", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_TEST[] = {
    ...
    {I_TEST, 2, {MEMORY,REG64,0}, "\321\300\1\x85\101", IF_X64|IF_SM},
    {I_TEST, 2, {REG64,REG64,0}, "\321\1\x85\101", IF_X64},
    ...
    {I_TEST, 2, {REG64,MEMORY,0}, "\321\301\1\x85\110", IF_X64|IF_SM},
    ...
    {I_TEST, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\xA9\41", IF_X64|IF_SM},
    ...
    {I_TEST, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\1\xF7\200\41", IF_X64|IF_SM},
...
static struct itemplate instrux_VMCALL[] = {
    {I_VMCALL, 0, {0,0,0}, "\3\x0F\x01\xC1", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMCLEAR[] = {
    {I_VMCLEAR, 1, {MEMORY,0,0}, "\3\x66\x0F\xC7\206", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMLAUNCH[] = {
    {I_VMLAUNCH, 0, {0,0,0}, "\3\x0F\x01\xC2", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMLOAD[] = {
    {I_VMLOAD, 0, {0,0,0}, "\3\x0F\x01\xDA", IF_X64|IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMMCALL[] = {
    {I_VMMCALL, 0, {0,0,0}, "\3\x0F\x01\xD9", IF_X64|IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMPTRLD[] = {
    {I_VMPTRLD, 1, {MEMORY,0,0}, "\2\x0F\xC7\206", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMPTRST[] = {
    {I_VMPTRST, 1, {MEMORY,0,0}, "\2\x0F\xC7\207", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMREAD[] = {
    {I_VMREAD, 2, {MEMORY,REG32,0}, "\2\x0F\x78\101", IF_VMX},
    {I_VMREAD, 2, {REG32,REG32,0}, "\2\x0F\x78\101", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMRESUME[] = {
    {I_VMRESUME, 0, {0,0,0}, "\3\x0F\x01\xC3", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMRUN[] = {
    {I_VMRUN, 0, {0,0,0}, "\3\x0F\x01\xD8", IF_X64|IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMSAVE[] = {
    {I_VMSAVE, 0, {0,0,0}, "\3\x0F\x01\xDB", IF_X64|IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMWRITE[] = {
    {I_VMWRITE, 2, {REG32,MEMORY,0}, "\2\x0F\x79\110", IF_VMX},
    {I_VMWRITE, 2, {REG32,REG32,0}, "\2\x0F\x79\110", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMXOFF[] = {
    {I_VMXOFF, 0, {0,0,0}, "\3\x0F\x01\xC4", IF_VMX},
    ITEMPLATE_END
};

static struct itemplate instrux_VMXON[] = {
    {I_VMXON, 1, {MEMORY,0,0}, "\3\xF3\x0F\xC7\206", IF_VMX},
    ITEMPLATE_END
};
...
static struct itemplate instrux_XADD[] = {
    ...
    {I_XADD, 2, {MEMORY,REG64,0}, "\321\300\2\x0F\xC1\101", IF_X64|IF_SM},
    {I_XADD, 2, {REG64,REG64,0}, "\321\2\x0F\xC1\101", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_XCHG[] = {
    {I_XCHG, 2, {REG_AX,REG16,0}, "\320\11\x90", IF_8086|IF_NOLONG},
    {I_XCHG, 2, {REG_EAX,REG32,0}, "\321\11\x90", IF_386|IF_NOLONG},
    {I_XCHG, 2, {REG16,REG_AX,0}, "\320\10\x90", IF_8086|IF_NOLONG},
    {I_XCHG, 2, {REG32,REG_EAX,0}, "\321\10\x90", IF_386|IF_NOLONG},
    {I_XCHG, 2, {REG_RAX,REG_RAX,0}, "\321\11\x90", IF_X64},
    ...
    {I_XCHG, 2, {REG64,MEMORY,0}, "\321\301\1\x87\110", IF_X64|IF_SM},
    {I_XCHG, 2, {REG64,REG64,0}, "\321\1\x87\110", IF_X64},
    ...
    {I_XCHG, 2, {MEMORY,REG64,0}, "\321\300\1\x87\101", IF_X64|IF_SM},
    {I_XCHG, 2, {REG64,REG64,0}, "\321\1\x87\101", IF_X64},
    ITEMPLATE_END
};
...
static struct itemplate instrux_XOR[] = {
    ...
    {I_XOR, 2, {MEMORY,REG64,0}, "\321\300\1\x31\101", IF_X64|IF_SM},
    {I_XOR, 2, {REG64,REG64,0}, "\321\1\x31\101", IF_X64},
    ...
    {I_XOR, 2, {REG64,MEMORY,0}, "\321\301\1\x33\110", IF_X64|IF_SM},
    {I_XOR, 2, {REG64,REG64,0}, "\321\1\x33\110", IF_X64},
    ...
    {I_XOR, 2, {REGMEM|BITS64,IMMEDIATE|BITS8,0}, "\321\300\1\x83\206\15", IF_X64},
    ...
    {I_XOR, 2, {REG_RAX,SBYTE,0}, "\321\1\x83\206\15", IF_X64|IF_SM},
    {I_XOR, 2, {REG_RAX,IMMEDIATE,0}, "\321\1\x35\41", IF_X64|IF_SM},
    ...
    {I_XOR, 2, {REGMEM|BITS64,IMMEDIATE,0}, "\321\300\144\1\x81\206\141", IF_X64|IF_SM},
...
static struct itemplate instrux_CMOVcc[] = {
    ...
    {I_CMOVcc, 2, {REG64,MEMORY,0}, "\321\301\1\x0F\330\x40\110", IF_X64|IF_SM},
    {I_CMOVcc, 2, {REG64,REG64,0}, "\321\1\x0F\330\x40\110", IF_X64},
    ITEMPLATE_END
};
